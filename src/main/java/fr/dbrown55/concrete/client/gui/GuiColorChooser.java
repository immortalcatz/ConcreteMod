package fr.dbrown55.concrete.client.gui;
...
public class GuiColorChooser extends GuiScreen {
	...
	private static final EntityConcreteBug bug = new EntityConcreteBug(Minecraft.getMinecraft().theWorld);
	...
	public void initGui() {
		...
		Color col;
		if(Minecraft.getMinecraft().thePlayer.getHeldItem(EnumHand.MAIN_HAND) != null && Minecraft.getMinecraft().thePlayer.getHeldItem(EnumHand.MAIN_HAND).hasTagCompound() && Minecraft.getMinecraft().thePlayer.getHeldItem(EnumHand.MAIN_HAND).getTagCompound().hasKey("color", 3)){
			col = new Color(Minecraft.getMinecraft().thePlayer.getHeldItem(EnumHand.MAIN_HAND).getTagCompound().getInteger("color"));
		} else {
			col = Color.WHITE;
		}
	...
	public void updateScreen() {
		super.updateScreen();
		this.updateColor();
		if(Minecraft.getMinecraft().thePlayer.getHeldItem(EnumHand.MAIN_HAND) == null || Minecraft.getMinecraft().thePlayer.getHeldItem(EnumHand.MAIN_HAND).getItem() != ItemHandler.brush){
	...
	public void onGuiClosed() {
		super.onGuiClosed();
		Main.wrapper.sendToServer(new SetPaintMessage(this.color));
	}
