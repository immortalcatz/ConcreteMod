...
public class BlockMagmaFence extends ConcreteFenceBase {

	public BlockMagmaFence() {
		super(new ResourceLocation("concrete", "magma_fence"));
		this.setLightLevel(0.2F);
	}

	@Override
	public String getDisplayName(ItemStack stack) {
		return TranslationHelper.translateAll("tile.magma_concrete_fence.name", "color." + EnumDyeColor.byMetadata(stack.getMetadata()).getName());
	}
