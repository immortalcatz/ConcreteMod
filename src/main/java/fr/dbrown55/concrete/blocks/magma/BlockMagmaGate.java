...
public class BlockMagmaGate extends ConcreteGateBase {

	private EnumDyeColor color;
	
	public BlockMagmaGate(EnumDyeColor color) {
		super(color, new ResourceLocation("concrete", "magma_gate_" + color.getName()));
		this.color = color;
	...
	public ItemStack getStack(IBlockState state, boolean pickBlock) {
		return new ItemStack(ItemHandler.MAGMA_GATE, 1, this.color.getMetadata());
	}
	...
	public String getDisplayName(ItemStack stack) {
		return TranslationHelper.translateAll("tile.magma_concrete_gate.name", "color." + EnumDyeColor.byMetadata(stack.getMetadata()).getName());
	}
