...
public class BlockMagmaConcretePowder extends BlockConcretePowder {

	public BlockMagmaConcretePowder() {
		super(EnumConcreteType.MAGMA);
	...
	public IBlockState getSolidState(IBlockState original) {
		return BlockHandler.magmaS.getDefaultState();
	}
