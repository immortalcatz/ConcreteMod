...
public class BlockMagmaSolid extends ConcreteBase {

	public BlockMagmaSolid() {
		super(new ResourceLocation("concrete", "magma_concrete"));
		this.setLightLevel(0.2F);
	}

	@Override
	public IBlockState getPowderState(IBlockState original) {
		return BlockStateHelper.copyProperties(original, BlockHandler.MAGMA_POWDER, BlockColored.COLOR);
	}
	...
	public String getDisplayName(ItemStack stack) {
		return TranslationHelper.translateAll("tile.magma_concrete.name", "color." + EnumDyeColor.byMetadata(stack.getMetadata()).getName());
	}
