...
public class BookPage {
	...
	public static void initPages() {
		if(!init) {
			...
			addPage("TABLE_OF_CONTENT", new BookString[] {new BookString("helpBook.tableOfContent"), new BookString(""), new BookStringClickable("helpBook.vanilla.title", EnumClickAction.SET_BOOK_PAGE, "VANILLA"), new BookStringClickable("helpBook.vanilla+.title", EnumClickAction.SET_BOOK_PAGE, "VANILLA+"), new BookStringClickable("helpBook.custom.title", EnumClickAction.SET_BOOK_PAGE, "CUSTOM"), new BookStringClickable("helpBook.links.title", EnumClickAction.SET_BOOK_PAGE, "LINKS")}, null);
